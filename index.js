...
console.log(createMenuItem('Global warming', 0 , 'Future'));
...
console.log(addReview(reviews, 'someone', 4, 'yes'));
...
function getLastReview(arrayOfObj) {

  const lastIndex = arrayOfObj.length - 1;

  return `${arrayOfObj[lastIndex].name} gave the restaurant a ${arrayOfObj[lastIndex].rating} star review, and their feedback was: ${arrayOfObj[lastIndex].feedback}`;
